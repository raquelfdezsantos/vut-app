        ...
        <form class="md:col-span-2 space-y-6" method="POST" action="#">
            <div class="grid sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" class="w-full bg-neutral-900 border border-neutral-700 rounded px-3 py-2 text-neutral-100" placeholder="DD/MM/AAAA" disabled>
                </div>
                <div>
            ...
            <div class="grid sm:grid-cols-3 gap-4">
                <div>
                    ...
                    <select class="w-full bg-neutral-900 border border-neutral-700 rounded px-3 py-2 text-neutral-100" disabled>
                        <option>1</option>
            ...
            <div>
                ...
                <textarea class="w-full bg-neutral-900 border border-neutral-700 rounded px-3 py-2 text-neutral-100 h-28" placeholder="Cuéntanos cualquier necesidad especial" disabled></textarea>
            </div>

            <div class="pt-2">
                <button type="button" class="bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-semibold px-5 py-2 rounded cursor-not-allowed opacity-60" disabled>
